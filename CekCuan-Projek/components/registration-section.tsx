    ...
    return (
      ...
      >
        <div className="mx-auto max-w-2xl px-6 text-center">
          <div className="rounded-2xl border border-primary/30 bg-card p-12">
            <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-primary/10">
              <Check className="h-10 w-10 text-primary" />
            </div>
            <h2 className="font-display text-3xl font-bold uppercase italic text-foreground md:text-4xl">
              Registrasi <span className="text-primary">Berhasil!</span>
            </h2>
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Selamat datang di CekCuan Pro, <strong className="text-foreground">{formData.fullName}</strong>! 
              Cek email Anda di <strong className="text-foreground">{formData.email}</strong> untuk 
              instruksi selanjutnya dan aktivasi akun Pro Anda.
            </p>
            <button
              type="button"
              onClick={() => {
              ...
              className="mt-8 inline-flex items-center gap-2 rounded-lg border border-border bg-transparent px-6 py-3 text-sm font-semibold text-foreground transition-all hover:bg-secondary"
            >
              Kembali ke Form
            </button>
          </div>
            ...
            <div className="sticky top-28 rounded-2xl border border-border bg-card p-8">
              ...
              <div className="mt-8 rounded-xl border border-border bg-secondary p-4">
                <p className="text-xs text-muted-foreground leading-relaxed">
                  <strong className="text-foreground">Garansi 30 hari.</strong>{" "}
